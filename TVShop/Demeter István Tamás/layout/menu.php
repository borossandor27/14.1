<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            ShortShop&COPY;
            <img src="./imgs/onlineshop.png" height="30" alt="ShortShop&COPY;">
        </a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                if ($_SESSION['login']) {
                    echo '<li class="nav-item">
                        <a class="nav-link' . ($menu == 'orokbefogadasUser' ? ' active' : '') . '" aria-current="page" href="index.php?menu=orokbefogadasUser">Termékek</a>
                      </li>
                        <li class = "nav-item">
                    ...
                    echo '<li class = "nav-item">
                        <a class = "nav-link' . ($menu == 'orokbefogadasGuest' ? ' active' : '') . '" aria-current = "page" href = "index.php?menu=orokbefogadasGuest">Termékek</a>
                    </li>
                    <li class = "nav-item">
