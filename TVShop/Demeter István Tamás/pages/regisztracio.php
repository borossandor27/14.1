...
if (filter_input(INPUT_POST, "regisztraciosAdatok", FILTER_VALIDATE_BOOLEAN, FILTER_NULL_ON_FAILURE)) {
    ...
    $teljes_nev = htmlspecialchars(filter_input(INPUT_POST, "felhasznalonev"));
    ...
    if ($error) {
        ...
        $db->register($username,$pass1,$emailcim,$teljes_nev,$igazolvanyszam);
...
<div class="col-8 mt-4 mx-auto">
    <form action="#" method="post" class="row needs-validation" novalidate>
        <div class="mb-3">
            <label for="felhasznalonev" class="form-label">Teljes neve:</label>
